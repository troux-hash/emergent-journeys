...
- There are TWO parts and you must mention both if asked about cost — never describe the subscription alone, as that understates what they pay:
  (1) a monthly subscription for visibility, equal to three nights at the rate of their CHEAPEST room, so it scales with their own rates rather than being a flat fee; and
